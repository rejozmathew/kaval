...
- Security remediation change: [`docs/change_requests/CR-0005-security-remediation.md`](docs/change_requests/CR-0005-security-remediation.md)
- Admin API exposure decision: [`docs/adr/019-admin-api-exposure-model.md`](docs/adr/019-admin-api-exposure-model.md)
- Backup/restore default-deny decision: [`docs/adr/020-backup-restore-default-deny.md`](docs/adr/020-backup-restore-default-deny.md)
- Outbound egress policy decision: [`docs/adr/021-outbound-egress-policy.md`](docs/adr/021-outbound-egress-policy.md)
- Approval-secret strength decision: [`docs/adr/022-approval-secret-strength.md`](docs/adr/022-approval-secret-strength.md)
