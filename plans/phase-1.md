...
- Service descriptor matching + shipped descriptors
- Dependency graph with confidence types
...
- P1-04 Service matcher
- P1-05 Dependency graph inference
